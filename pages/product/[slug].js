      ...
      <section className="text-gray-600 body-font overflow-hidden min-h-screen">
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              className="  lg:w-1/2  w-full lg: h-full px-24 object-co ${ color === 'white' ? 'border-black' : 'border-gray-300'}ver object-top rounded"
              src={product.img}
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button className="rounded-full w-10 h-10 bg-gray-200 p-0 b ${ color === 'white' ? 'border-black' : 'border-gray-300'}order-0 inline-flex items-center justify-center text-gray-500 ml-4">
                  <svg
                    fill="currentColor"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              {!service && service != null && (
                <div className="text-red-700 text-sm mt-3">
                  Sorry! We do not deliver to this product yet.
                </div>
              )}
              {service && service != null && (
                <div className="text-green-700 text-sm mt-3">
                  Yay!This pin is servicable.
                </div>
              )}
            </div>
          </div>
...
export async function getServerSideProps(context) {
  ...
  let colorSizeSlug = {}; // {red: {XL: {slug: code-wear-red}}}
